...
elseif(WINDOWS_PHONE OR WINDOWS_STORE)
  ...
  set(_PLATFORM_DEFINES "/DWIN32 /D_UNICODE /DUNICODE")
...
foreach(t EXE SHARED MODULE)
  ...
  string(APPEND CMAKE_${t}_LINKER_FLAGS_MINSIZEREL_INIT "/debug /INCREMENTAL:NO")
  string(APPEND CMAKE_${t}_LINKER_FLAGS_RELEASE_INIT "/debug /INCREMENTAL:NO")
endforeach()
...
macro(__windows_compiler_msvc lang)
  ...
  if("x${lang}" STREQUAL "xC" OR
    ...
    if(CMAKE_VS_PLATFORM_TOOLSET MATCHES "v[0-9]+_clang_.*")
      ...
      string(APPEND CMAKE_${lang}_FLAGS_DEBUG_INIT " /MDd /Zi /Ob0 /Od ${_RTC1} /D_DEBUG")
      string(APPEND CMAKE_${lang}_FLAGS_RELEASE_INIT " /MD /Zi /O2 /Ob2 /DNDEBUG")
      string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " /MD /Zi /O2 /Ob1 /DNDEBUG")
      string(APPEND CMAKE_${lang}_FLAGS_MINSIZEREL_INIT " /MD /Zi /O1 /Ob1 /DNDEBUG")
    endif()
  endif()
